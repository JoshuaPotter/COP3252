...
public class CreateFile {
   public static void main(String[] args) {
      ...
      System.out.printf("%s%n%s%n? ", 
         ...
         "Enter end-of-file indicator to end input (ctrl+z, oldmast.xml).");

      // open oldmast.txt, output data to the file then close oldmast.txt
      ...
      System.out.printf("%s%n%s%n? ", 
         ...
         "Enter end-of-file indicator to end input (ctrl+z, trans.xml).");

      // open trans.txt, output data to the file then close trans.xml
